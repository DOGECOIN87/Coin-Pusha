            ...
            <div className="flex flex-row sm:flex-col gap-1.5 sm:gap-2">
                ...
                <div className="relative group w-[120px] sm:w-[200px]">
                    ...
                    <div className="relative flex flex-col items-end pr-3 sm:pr-5 py-1 sm:py-2">
                        ...
                        <div className={`text-lg sm:text-3xl font-bold font-heading tracking-wider sm:tracking-widest drop-shadow-[0_0_10px_rgba(0,255,0,0.3)] ${state.balance <= 0 ? 'text-red-500 animate-pulse' : 'text-white'}`}>
                            {state.balance}
                        </div>
                    </div>
                </div>
                ...
                <div className="relative group w-[120px] sm:w-[200px]">
                     ...
                     <div className="relative flex flex-col items-end pr-3 sm:pr-5 py-1 sm:py-2">
                        ...
                        <div className={`text-sm sm:text-xl font-bold font-heading tracking-wide ${state.netProfit >= 0 ? 'text-green-400' : 'text-rose-400'} drop-shadow-[0_0_5px_currentColor]`}>
